 ...
 * Displays the main content area with title, subtitle, floating icon, and bridge text
...
import { useTimingAnimation } from '../../utils/timingSystem';
import { useMainContentCarousel } from '../../utils/carouselSystem';
...
export const MainContent: React.FC<MainContentProps> = ({
  ...
  // Render carousel mode if enabled
  if (shouldUseCarousel && carousel.currentSlide) {
    return (
      <motion.div 
      ...
      >
        ...
        >
          <div className="h-0.5 bg-white/10 overflow-hidden">
            <motion.div 
              ...
              initial={{ width: 0 }}
              animate={{ width: `${carousel.progress}%` }}
        ...
        >
          ...
          >
            <AnimatePresence mode="wait">
              <motion.div
                ...
                className={`w-28 h-28 rounded-3xl flex items-center justify-center shadow-2xl border border-white/30 relative overflow-hidden ${
                  carousel.currentSlide.type === 'vocabulary' 
                    ? 'bg-gradient-to-br from-amber-400 via-orange-500 to-red-500'
                    : carousel.currentSlide.type === 'concept'
              ...
              >
                ...
                <div className="relative z-10 drop-shadow-lg">
                  {renderIcon(carousel.currentSlide.icon, { 
                    size: 56, 
            ...
            <AnimatePresence mode="wait">
              <motion.div
                key={`glow-${carousel.currentSlide.id}`}
                ...
                >
                  ...
                  <div className="relative z-10">
                    <span className="text-blue-100 text-xl leading-relaxed block">
                      {carousel.currentSlide.description}
                    </span>
                  </div>
                </motion.div>
              </motion.div>
