/**
 * EducationalTemplate Component - Unified Animation System
 * Updated to use unified animation system while preserving exact visual design
 * Wraps entire template with UnifiedAnimationProvider
 */
...
import { UnifiedAnimationProvider } from '../../../contexts/UnifiedAnimationContext';
import { MainContent } from '../sections/MainContentUnified';
...
export const EducationalTemplate: React.FC<EducationalTemplateProps> = ({
  ...
  return (
    <UnifiedAnimationProvider
      vocabularyItems={config.content.vocabulary || []}
      conceptItems={config.content.concepts || []}
